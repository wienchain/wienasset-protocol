This set of OP_CODES are only recognized by the wienasset software and should not be confused with [Bitcoin OP_CODES](https://en.bitcoin.it/wiki/Script) (such as OP_RETURN).
